...
if (isset($_POST['action']) && $_POST['action'] === 'create_case_from_chat') {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        $auditLogger->logAction(
            ...
            'Case Management',
            "Created case from chat: $title (Type: $case_type, Status: $status, Client ID: $client_id)",
            'success',
            'medium'
        );
        echo 'success';
                    ...
                    <form id="createCaseForm">
                        <div class="form-row">
                            ...
                            <div class="form-column">
                                ...
                                <div class="form-group">
                                    <label><i class="fas fa-calendar-alt" style="margin-right: 8px; color: var(--accent-color);"></i>Next Hearing</label>
                                    <input type="date" name="next_hearing">
                                    <small><i class="fas fa-info-circle" style="margin-right: 4px;"></i>Optional. Leave blank if not yet scheduled.</small>
                                </div>
                            </div>
                        </div>
