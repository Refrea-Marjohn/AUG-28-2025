...
<body>
    ...
    <div class="main-content">
        ...
        <div class="upcoming-events-section">
            ...
            <div class="events-grid">
                ...
                <div class="event-card status-<?= strtolower($ev['status']) ?>" data-event-id="<?= $ev['id'] ?>" data-attorney-id="<?= $_SESSION['user_id'] ?>" data-attorney-name="<?= htmlspecialchars($_SESSION['attorney_name'] ?? 'Attorney') ?>">
                    <div class="event-card-header">
                        ...
                        <div class="event-info">
                            ...
                            <p class="attorney-indicator">
                                ...
                                <span class="attorney-name"><?= htmlspecialchars($_SESSION['attorney_name'] ?? 'Attorney') ?></span>
                            </p>
                        </div>
                    </div>
    ...
    <style>
        ...
        /* Attorney Color Coding System - Based on Attorney Names */
        .event-card[data-attorney-name] {
            position: relative;
        }

        /* Mario Refrea - Light Blue */
        .event-card[data-attorney-name="Mario Refrea"] {
            border-left: 4px solid #74c0fc;
            background: linear-gradient(135deg, rgba(116, 192, 252, 0.05) 0%, rgba(116, 192, 252, 0.1) 100%);
        }

        /* Ken Anthony Juson - Light Green */
        .event-card[data-attorney-name="Ken Anthony Juson"] {
            border-left: 4px solid #51cf66;
            background: linear-gradient(135deg, rgba(81, 207, 102, 0.05) 0%, rgba(81, 207, 102, 0.1) 100%);
        }

        /* Attorney 3 - Light Violet */
        .event-card[data-attorney-name="Attorney 3"] {
            border-left: 4px solid #da77f2;
            background: linear-gradient(135deg, rgba(218, 119, 242, 0.05) 0%, rgba(218, 119, 242, 0.1) 100%);
        }

        /* Default attorney color */
        .event-card[data-attorney-name]:not([data-attorney-name="Mario Refrea"]):not([data-attorney-name="Ken Anthony Juson"]):not([data-attorney-name="Attorney 3"]) {
    ...
    <script>
        ...
        function updateEventCardUI(selectElement, newStatus) {
            ...
            // Attorney color coding system based on names (same as admin schedule)
            const attorneyColors = {
                'Mario Refrea': '#74c0fc', // Light Blue
                'Ken Anthony Juson': '#51cf66', // Light Green
                'Attorney 3': '#da77f2' // Light Violet
            };
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventDidMount: function(info) {
                    ...
                    // Attorney-based color coding - consistent color per attorney
                    if (attorneyName === 'Mario Refrea') {
                        backgroundColor = '#74c0fc'; // Light Blue for Mario Refrea
                        borderColor = '#4dabf7';
                        console.log('Applying MARIO REFREA colors:', backgroundColor);
                    } else if (attorneyName === 'Ken Anthony Juson') {
                        backgroundColor = '#51cf66'; // Light Green for Ken Anthony Juson
                        borderColor = '#40c057';
                        console.log('Applying KEN ANTHONY JUSON colors:', backgroundColor);
            ...
            function initializeAttorneyColorCoding() {
                ...
                cards.forEach(card => {
                    ...
                    // Apply attorney color coding
                    if (attorneyName && attorneyColors[attorneyName]) {
                        card.style.borderLeftColor = attorneyColors[attorneyName];
                    }
                });
            }
