...
foreach ($events as $ev) {
    ...
    if ($attorney_name === $_SESSION['admin_name']) {
        // Admin - Light Red
        $color = '#ff6b6b';
    } elseif ($attorney_name === 'Ken Anthony Juson') {
        // Attorney 1 - Light Green
        $color = '#51cf66';
    } elseif ($attorney_name === 'Mario Refrea') {
        // Attorney 2 - Light Blue
        $color = '#74c0fc';
    } elseif ($attorney_name === 'Attorney 3') {
        // Attorney 3 - Light Violet
        $color = '#da77f2';
    } else {
        // Other attorneys - Light Orange
        $color = '#ffd43b';
    }
...
<body>
    ...
    <style>
        ...
        /* Specific Attorney Color Coding */
        .event-card[data-attorney="Ken Anthony Juson"] {
            background: linear-gradient(135deg, rgba(81, 207, 102, 0.08) 0%, rgba(81, 207, 102, 0.15) 100%);
            border-left: 4px solid #51cf66;
        }

        .event-card[data-attorney="Mario Refrea"] {
            background: linear-gradient(135deg, rgba(116, 192, 252, 0.08) 0%, rgba(116, 192, 252, 0.15) 100%);
            border-left: 4px solid #74c0fc;
        }

        .event-card[data-attorney="Attorney 3"] {
            background: linear-gradient(135deg, rgba(218, 119, 242, 0.08) 0%, rgba(218, 119, 242, 0.15) 100%);
        ...
        /* Specific Attorney Avatar Colors */
        .event-card[data-attorney="Ken Anthony Juson"] .avatar-placeholder {
            background: linear-gradient(135deg, #51cf66 0%, #40c057 100%);
        }

        .event-card[data-attorney="Mario Refrea"] .avatar-placeholder {
            background: linear-gradient(135deg, #74c0fc 0%, #4dabf7 100%);
        }

        .event-card[data-attorney="Attorney 3"] .avatar-placeholder {
